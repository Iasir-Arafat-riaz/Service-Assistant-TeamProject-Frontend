...
export const saveUserToDb = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.post(
      `https://dry-sea-00611.herokuapp.com/users/register`,
      info
    );
...
export const makeAdmin = createAsyncThunk("data/makeAdmin", async (info) => {
  //console.log(info);
  const response = await axios.put(
    `https://dry-sea-00611.herokuapp.com/admin/makeadmin/${info.email} `,
    info
  );
  return response.data;
});
export const isAdmin = createAsyncThunk("data/isAdmin", async (info) => {
  const response = await axios.get(
    `https://dry-sea-00611.herokuapp.com/admin/checkadmin/${info.email}`
  );
  return response.data;
});
export const getAllUser = createAsyncThunk("data/getAllUser", async (info) => {
  const response = await axios.get(
    `https://dry-sea-00611.herokuapp.com/users/allusers`
  );
  return response.data;
});
...
export const singleService = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://dry-sea-00611.herokuapp.com/singleservice"
    );
    return response.data;
  }
);
...
export const websiteReviews = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://dry-sea-00611.herokuapp.com/reviews"
    );
    return response.data;
  }
);
...
export const deleteTestimonial = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios
      .delete(`https://dry-sea-00611.herokuapp.com/reviews/${info.id}`)
      .then(() => {
        Swal.fire("Deleted", "This testimonial has been deleted", "success");
      });
    return response.data;
  }
);
...
export const approvedTestimonial = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios
      .put(`https://dry-sea-00611.herokuapp.com/reviews/${info.id}`)
      .then(() => {
        Swal.fire("Approved!", "This testimonial has been approved", "success");
      });
    return response.data;
  }
);
...
export const serviceProviders = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://dry-sea-00611.herokuapp.com/users/finding/ids",
      {
        params: {
          data: ["62121eb1cef8c7b4915a6923", "6211cbf6bb809e9e3edb1859"],
        },
      }
    );
    return response.data;
...
export const postChat = createAsyncThunk("chat/postChat", async (info) => {
  const response = await axios.post(
    "https://dry-sea-00611.herokuapp.com/chat",
    info
  );
  return response.data;
});
export const getChatFromDb = createAsyncThunk("chat/postChat", async (info) => {
  const response = await axios.get(`https://dry-sea-00611.herokuapp.com/chat`);
  return response.data;
});

export const saveService = createAsyncThunk("service/save", async (info) => {
  //console.log(info)
  const response = await axios.post(
    "https://dry-sea-00611.herokuapp.com/saveservice",
    info
  );
  return response.data;
});
...
export const getNotification = createAsyncThunk(
  ...
  async (info) => {
    // console.log(info)
    const response = await axios.get(
      `http://localhost:5000/notification/getnotification?email=${info.email}`
    );
    return response.data;
  }
);
...
export const updateMessageStatus = createAsyncThunk(
  ...
  async (info) => {
    const response = await axios.put(
      `http://localhost:5000/notification/statuschange/${info.email}`
    );
    return response.data;
  }
);
