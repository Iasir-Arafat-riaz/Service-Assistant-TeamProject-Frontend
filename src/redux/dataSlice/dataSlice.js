...
export const saveUserToDb = createAsyncThunk(
    'saveUserToDb/user',
    async (info) => {
        const response = await axios.post(`https://service-assistant-a2z-backend-production.up.railway.app/users/register`, info);
...
export const putUserToDb = createAsyncThunk(
    'data/putUserToDb',
    async (info) => {
        const response = await axios.put(`https://service-assistant-a2z-backend-production.up.railway.app/users/register `, info);
        return response.data
    }
)
export const makeAdmin = createAsyncThunk(
    ...
    async (info) => {
        //
        const response = await axios.put(`https://service-assistant-a2z-backend-production.up.railway.app/admin/makeadmin/${info.email} `, info);
        return response.data
    }
)
export const isAdmin = createAsyncThunk(
    'data/isAdmin',
    async (info) => {
        const response = await axios.get(`https://service-assistant-a2z-backend-production.up.railway.app/admin/checkadmin/${info.email}`);
        return response.data
    }
)
export const getAllUser = createAsyncThunk(
    'data/getAllUser',
    async (info) => {
        const response = await axios.get(`https://service-assistant-a2z-backend-production.up.railway.app/users/allusers`);
        return response.data
    }
)
...
export const singleService = createAsyncThunk(
    ...
    async (info) => {
        const response = await axios.get(`https://service-assistant-a2z-backend-production.up.railway.app/singleservice/${info}`)
        return response.data;
    }
);
...
export const websiteReviews = createAsyncThunk(
    "testimonials/data",
    async () => {
        const response = await axios.get("https://service-assistant-a2z-backend-production.up.railway.app/reviews")
        return response.data;
    }
)
...
export const deleteTestimonial = createAsyncThunk(
    ...
    async (info) => {
        const response = await axios.delete(`https://service-assistant-a2z-backend-production.up.railway.app/reviews/${info.id}`)
        return response.data;
    }
)
...
export const approvedTestimonial = createAsyncThunk(
    ...
    async (info) => {
        const response = await axios.put(`https://service-assistant-a2z-backend-production.up.railway.app/reviews/${info.id}`)
        return response.data;
    }
);
...
export const serviceProviders = createAsyncThunk(
    "providers/service",
    async (info) => {
        const response = await axios.get('https://service-assistant-a2z-backend-production.up.railway.app/users/finding/ids', {
            params: {
                data: info
            }
        })
...
export const postChat = createAsyncThunk(
    "chat/postChat",
    async (info) => {
        const response = await axios.post('https://service-assistant-a2z-backend-production.up.railway.app/chat', info)
        return response.data;
    }
);
export const getChatFromDb = createAsyncThunk(
    "chat/postChat",
    async (info) => {
        const response = await axios.get(`https://service-assistant-a2z-backend-production.up.railway.app/chat`);
        return response.data;
    }
);
...
export const saveService = createAsyncThunk(
    ...
    async (info) => {
        //
        const response = await axios.post('https://service-assistant-a2z-backend-production.up.railway.app/saveservice', info)
        return response.data;
    }
);
...
export const getNotification = createAsyncThunk(
    ...
    async (info) => {
        // 
        const response = await axios.get(`https://service-assistant-a2z-backend-production.up.railway.app/notification/getnotification?email=${info.email}`)
        return response.data;
    }
)
...
export const updateMessageStatus = createAsyncThunk("update/notificationstatus",
    async (info) => {
        const response = await axios.put(`https://service-assistant-a2z-backend-production.up.railway.app/notification/statuschange/${info.email}`)
        return response.data;
    }
)
export const sendNotification = createAsyncThunk("sendNotification/notification",
    async (info) => {
        ...
        const response = await axios.post(`https://service-assistant-a2z-backend-production.up.railway.app/notification`, modifyInfo)
        return response.data;
    }
)
export const getProviderChatsDb = createAsyncThunk(
    ...
    async (info) => {
        // 
        const response = await axios.get(`https://service-assistant-a2z-backend-production.up.railway.app/chat/provider/${info.email}`)
        return response.data;
    }
)
...
export const getOtherOrders = createAsyncThunk(
    ...
    async (info) => {
        // 
        const response = await axios.get(`https://service-assistant-a2z-backend-production.up.railway.app/provider/appointment/${info.email}`)
        return response.data;
    }
)
...
export const getSingleOrdersChat = createAsyncThunk(
    ...
    async (info) => {
        // 
        const response = await axios.get(`https://service-assistant-a2z-backend-production.up.railway.app/chat/singleOrder/${info.id}`)
...
export const getProviderDetailsByEmail = createAsyncThunk(
    ...
    async (info) => {
        // 
        const response = await axios.get(`https://service-assistant-a2z-backend-production.up.railway.app/providerdetials/provider?email=${info.email}`)
