...
// https://service-assistant.adaptable.app/
...
const PendingProviders = () => {
    ...
    useEffect(() => {
        setDataLoad(true);
        axios.get(`https://service-assistant.adaptable.app/addprovider`).then(res => {
    ...
    useEffect(() => {
        axios.get(`https://service-assistant.adaptable.app/users/${user.email}`).then(res => setProvider(res.data))
    }, [user])
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    setLoading(true);
                    axios.put(`https://service-assistant.adaptable.app/addprovider/approveprovider?uid=${matchUser?.uid}`).then(res => {
                        axios.post(`https://service-assistant.adaptable.app/addprovider/addproviderkey/${parentId}`, { key: matchUser._id });
                        axios.delete(`https://service-assistant.adaptable.app/addprovider/deleteprovider/${id}`).then(res => {
                            ...
                            axios.post('https://service-assistant.adaptable.app/providerdetials', { offerService, backgroundImage, date, AvgRating: rating, reviewUser, reviews: [], ...data, providerId: provider._id })
