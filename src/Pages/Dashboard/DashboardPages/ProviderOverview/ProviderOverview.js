...
const ProviderOverview = () => {
    ...
    useEffect(() => {
        const pendingOrders = axios.get(`https://service-assistant.adaptable.app/provider/pending/appointment/${user.email}`);
        const approvedOrders = axios.get(`https://service-assistant.adaptable.app/provider/approved/appointment/${user.email}`);
        const completedOrders = axios.get(`https://service-assistant.adaptable.app/provider/completed/appointment/${user.email}`);
