...
import { Divider, Drawer, List, ListItem, ListItemText, AppBar, Box, Toolbar, IconButton, Typography, Menu, Avatar, Button, Tooltip, MenuItem, Container } from '@mui/material';
    ...
    const list = (
        ...
        >
            <List sx={{ mt: '50%' }}>
                ...
                <Divider sx={{ color: '#98a1bc' }} />
                <ListItem>
                    {user.email && <ListItemText sx={{ color: "black" }}>
            ...
            <AppBar id="navbar" className={navbar} position="fixed" style={{ boxShadow: 'none' }} sx={{ paddingX: 3, paddingY: 1, background: 'none' }}>
                ...
                <Toolbar disableGutters sx={{ display: 'flex', justifyContent: "space-between", ml: 2 }}>
                    ...
                    <Box style={{ zIndex: '9999' }} className={navItemContainer}>
                        ...
                        <Button variant='text'> <NavLink style={navLink} to="/SERVICES">SERVICES</NavLink></Button>

                        {/* <Button variant="text"> <NavLink style={navLink} to="/dashboard ">DASHBOARD</NavLink></Button> */}

                        <Button variant='text'> <NavLink style={navLink} to="/Dashboard">DASHBOARD</NavLink></Button>

                        <Button variant="text"> <NavLink style={navLink} to="/Contact">CONTACT US</NavLink></Button>
